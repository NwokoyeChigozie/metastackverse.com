...
//            $resultMessage = "<p class='success'>Registration successful</p>";
            echo '<div class="alert alert-success" style="border-radius:3px;text-align:center;background-color:green;color:#fff;padding:10px 85px;margin-top:0px">Thank you for registering with Meta Stack Options. </div>';
